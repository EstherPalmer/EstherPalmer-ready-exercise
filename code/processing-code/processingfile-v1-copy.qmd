...
Now checking the `Pet_owned` variable. Pets_owned should be a categorical/factor variable but is loaded as character. We can fix that with simple base R code to mix things up.
