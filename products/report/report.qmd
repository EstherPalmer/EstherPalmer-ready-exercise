...
I added 2 variables, pets owned and number of books read. Pets owned is what type of pets each person in the data set owns, ignoring the fact that some people own multiple types. The number of books read is the number of books read by each person in the last year.
